...
if (isset($_POST['checkout'])) {
    ...
    // Add delivery fee
    $delivery_fee = 5.00;
    $total_price = floatval($total_price) + $delivery_fee;
            ...
            <div id="home" class="tab-content active">
                ...
                <div style="background: white; padding: 2rem; border-radius: 15px; box-shadow: 0 5px 15px rgba(0,0,0,0.1); margin-bottom: 3rem;">
                    ...
                    <div style="display: flex; justify-content: center; gap: 2rem; flex-wrap: wrap;">
                        <a href="#" id="facebook-link" style="display: flex; align-items: center; gap: 0.5rem; padding: 1rem 2rem; background: #1877f2; color: white; text-decoration: none; border-radius: 10px; transition: transform 0.3s;" onmouseover="this.style.transform='translateY(-2px)'" onmouseout="this.style.transform='translateY(0)'">
                            <span style="font-size: 1.5rem;">📘</span>
                            Facebook
                        </a>
                        <a href="#" id="instagram-link" style="display: flex; align-items: center; gap: 0.5rem; padding: 1rem 2rem; background: linear-gradient(45deg, #f09433 0%,#e6683c 25%,#dc2743 50%,#cc2366 75%,#bc1888 100%); color: white; text-decoration: none; border-radius: 10px; transition: transform 0.3s;" onmouseover="this.style.transform='translateY(-2px)'" onmouseout="this.style.transform='translateY(0)'">
                            <span style="font-size: 1.5rem;">📷</span>
                            Instagram
                        </a>
                        <a href="#" id="whatsapp-link" style="display: flex; align-items: center; gap: 0.5rem; padding: 1rem 2rem; background: #25d366; color: white; text-decoration: none; border-radius: 10px; transition: transform 0.3s;" onmouseover="this.style.transform='translateY(-2px)'" onmouseout="this.style.transform='translateY(0)'">
                            <span style="font-size: 1.5rem;">💬</span>
                            WhatsApp
                        </a>
                        <a href="#" id="tiktok-link" style="display: flex; align-items: center; gap: 0.5rem; padding: 1rem 2rem; background: #000; color: white; text-decoration: none; border-radius: 10px; transition: transform 0.3s;" onmouseover="this.style.transform='translateY(-2px)'" onmouseout="this.style.transform='translateY(0)'">
                            <span style="font-size: 1.5rem;">🎵</span>
                            TikTok
                        </a>
                    </div>
